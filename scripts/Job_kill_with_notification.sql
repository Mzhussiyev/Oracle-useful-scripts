Declare
 ...
 ;
  ...
  RW CUR%Rowtype;
  EMAIL_ADDRESS_OUT varchar2(100) := 'sender@server.kz;';
  EMAIL_ADDRESS_IN VARCHAR2(4000) := 'medeujusiev@gmail.com;';
...
Begin
  ...
  begin
    ...
    IF    RW.JOB_NAME LIKE '%\_MZ\_%' ESCAPE '\'  THEN V_NAME := 'MZhussiyev@gmail.com;'; 
    ELSIF RW.JOB_NAME LIKE '%\_NA\_%' ESCAPE '\'  THEN V_NAME := 'medeujusiev@gmail.com;';
    END IF;
